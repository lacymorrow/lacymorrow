...
<Center className="max-w-md my-8 mx-auto">
	![Invitae Screenshot](/static/work/twilio/logo.png)
</Center>
...
<Center className="max-w-sm mx-auto">
...
**View the [Twilio Magic Site](/static/work/twilio/twilio-magic/index.html) live.**
